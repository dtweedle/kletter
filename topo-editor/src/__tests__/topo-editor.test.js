...
const topo_editor_1 = require("../topo-editor");
const topo_tool_1 = require("../../../topo-render/src/topo-tool");
/**
...
describe('TopoEditor', () => {
    describe('constructor', () => {
        ...
        it('should accept custom width and height', () => {
            ...
            const editor = new topo_editor_1.TopoEditor(renderer, options);
            expect(editor).toBeDefined();
        });
        it('should accept custom curveIntensity', () => {
            const renderer = new topo_tool_1.TopoRender();
            const options = { curveIntensity: 1.5 };
            const editor = new topo_editor_1.TopoEditor(renderer, options);
            expect(editor).toBeDefined();
        });
    ...
    describe('setIntensity', () => {
        it('should accept numeric intensity values', () => {
            const renderer = new topo_tool_1.TopoRender({ width: 200, height: 200, curveIntensity: 1 });
            const editor = new topo_editor_1.TopoEditor(renderer, { width: 200, height: 200, curveIntensity: 1 });
            expect(() => {
    ...
    describe('dependency injection', () => {
        it('should accept TopoRender as a dependency', () => {
            const renderer = new topo_tool_1.TopoRender({ width: 300, height: 250 });
            const editor = new topo_editor_1.TopoEditor(renderer);
            expect(editor).toBeDefined();
        });
        it('should work with differently configured renderers', () => {
            const renderer1 = new topo_tool_1.TopoRender({ width: 200, height: 200 });
            const editor1 = new topo_editor_1.TopoEditor(renderer1);
            const renderer2 = new topo_tool_1.TopoRender({ width: 500, height: 400 });
            const editor2 = new topo_editor_1.TopoEditor(renderer2);
    ...
    describe('contract compliance', () => {
        it('should match TopoEditorOptions interface', () => {
            ...
            const options1 = {};
            const editor1 = new topo_editor_1.TopoEditor(renderer, options1);
            expect(editor1).toBeDefined();
            const options2 = { width: 300 };
            const editor2 = new topo_editor_1.TopoEditor(renderer, options2);
            expect(editor2).toBeDefined();
            const options3 = { height: 250 };
            const editor3 = new topo_editor_1.TopoEditor(renderer, options3);
            expect(editor3).toBeDefined();
            const options4 = { curveIntensity: 1.5 };
            const editor4 = new topo_editor_1.TopoEditor(renderer, options4);
            ...
            const editor5 = new topo_editor_1.TopoEditor(renderer, options5);
    ...
    describe('lifecycle', () => {
        ...
        it('should allow multiple editors with same renderer', () => {
            const renderer = new topo_tool_1.TopoRender();
            const editor1 = new topo_editor_1.TopoEditor(renderer);
            const editor2 = new topo_editor_1.TopoEditor(renderer);
            expect(editor1).toBeDefined();
            expect(editor2).toBeDefined();
            editor1.destroy();
            editor2.destroy();
    ...
    describe('interface compatibility', () => {
        ...
        it('should allow partial TopoEditorOptions', () => {
            const renderer = new topo_tool_1.TopoRender();
            const partialOptions1 = { width: 300 };
            const editor1 = new topo_editor_1.TopoEditor(renderer, partialOptions1);
            expect(editor1).toBeDefined();
            const partialOptions2 = { curveIntensity: 2 };
            const editor2 = new topo_editor_1.TopoEditor(renderer, partialOptions2);
            expect(editor2).toBeDefined();
            const partialOptions3 = {};
            const editor3 = new topo_editor_1.TopoEditor(renderer, partialOptions3);
            expect(editor3).toBeDefined();
        });
    });
});
